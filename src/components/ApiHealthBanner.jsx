...
export default function ApiHealthBanner() {
  ...
  return (
    <div className="bg-red-600 text-white text-xs font-semibold px-4 py-2 flex flex-col sm:flex-row items-center justify-center gap-1 sm:gap-2 text-center sm:text-left">
